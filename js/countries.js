/* ============================================================
   F1 TAXI — countries.js
   ISO 3166-1 alpha-2 + E.164 dial codes for the phone picker.
   Flags are derived from the ISO code at runtime (regional
   indicator pairs), so no flag images ship with the site.
   Exposes window.F1_COUNTRIES.
   ============================================================ */

window.F1_COUNTRIES = [
  ['Afghanistan', 'AF', '93'], ['Albania', 'AL', '355'], ['Algeria', 'DZ', '213'],
  ['American Samoa', 'AS', '1684'], ['Andorra', 'AD', '376'], ['Angola', 'AO', '244'],
  ['Anguilla', 'AI', '1264'], ['Antigua & Barbuda', 'AG', '1268'], ['Argentina', 'AR', '54'],
  ...
  ['Brazil', 'BR', '55'], ['British Indian Ocean Territory', 'IO', '246'],
  ...
  ['Mozambique', 'MZ', '258'], ['Myanmar (Burma)', 'MM', '95'], ['Namibia', 'NA', '264'],
  ...
  ['Rwanda', 'RW', '250'], ['Samoa', 'WS', '685'], ['San Marino', 'SM', '378'],
  ['São Tomé & Príncipe', 'ST', '239'], ['Saudi Arabia', 'SA', '966'], ['Senegal', 'SN', '221'],
  ...
  ['Spain', 'ES', '34'], ['Sri Lanka', 'LK', '94'], ['St. Barthélemy', 'BL', '590'],
  ['St. Helena', 'SH', '290'], ['St. Kitts & Nevis', 'KN', '1869'], ['St. Lucia', 'LC', '1758'],
  ['St. Martin', 'MF', '590'], ['St. Pierre & Miquelon', 'PM', '508'],
  ['St. Vincent & Grenadines', 'VC', '1784'], ['Sudan', 'SD', '249'], ['Suriname', 'SR', '597'],
  ['Svalbard & Jan Mayen', 'SJ', '47'], ['Sweden', 'SE', '46'], ['Switzerland', 'CH', '41'],
  ...
  ['Trinidad & Tobago', 'TT', '1868'], ['Tunisia', 'TN', '216'], ['Türkiye', 'TR', '90'],
  ['Turkmenistan', 'TM', '993'], ['Turks & Caicos Islands', 'TC', '1649'], ['Tuvalu', 'TV', '688'],
  ...
  ['Wallis & Futuna', 'WF', '681'], ['Western Sahara', 'EH', '212'], ['Yemen', 'YE', '967'],
